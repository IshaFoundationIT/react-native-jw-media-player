...
public class Util {
    ...
    /** Isha Foundation custom method */
    private static boolean isha_doesPackageExist(PackageManager packageManager, String targetPackage) {
        try {
     ...
     * */
    public static boolean isha_isGoogleApiAvailable(Context context) {
        PackageManager packageManager = context.getPackageManager();
        boolean isOldPlayStoreInstalled = isha_doesPackageExist(packageManager, GOOGLE_PLAY_STORE_PACKAGE_NAME_OLD);
        boolean isNewPlayStoreInstalled = isha_doesPackageExist(packageManager, GOOGLE_PLAY_STORE_PACKAGE_NAME_NEW);
